  ...
  return (
    <section id="about" className="section about">
      <div className="container">
        ...
        <p>
          I am always eager to learn new technologies, improve my craft, and take on new challenges. My ultimate goal is to contribute to projects that make a positive impact, while continually growing as a developer and as a person.
        </p>
      </div>
    </section>
  );
